...
public class GetInstructorDetailDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<InstructorDetail> tempInstructorDetail = query.getResultList();

			for (InstructorDetail oneInstructorDetail : tempInstructorDetail) {
				System.out.println(oneInstructorDetail.getYoutubeChannel());
			}
			*/
